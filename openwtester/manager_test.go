...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO LUNA", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WCCzmn2UNijF7c8rCLsJFE5Xe5q8ddtQcq")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WCCzmn2UNijF7c8rCLsJFE5Xe5q8ddtQcq"
	account := &openwallet.AssetsAccount{Alias: "HELLO LUNA", WalletID: walletID, Required: 1, Symbol: "LUNA", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WCCzmn2UNijF7c8rCLsJFE5Xe5q8ddtQcq"
	accountID := "Dd4gAqptJ1dDw3qt8Q4CG6b8RnZeYzP5hVcfihDyJekK"
...
func TestWalletManager_GetAddressList(t *testing.T) {
	...
	for i, w := range list {
		...
		// log.Info("public key [", i, "] :", w.PublicKey)
	}
